<%@ Page Title="" Language="C#"  MasterPageFile="~/Masterpage.Master" AutoEventWireup="true"  CodeBehind="DangKy.aspx.cs" Inherits="ZaraShop.Signup" EnableEventValidation ="false" %>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="nhap">
                                        ...
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator8" runat="server" ErrorMessage="" ControlToValidate="txtNamSinh" ForeColor="Red">Bạn chưa nhập năm sinh</asp:RequiredFieldValidator>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="nhap"><asp:TextBox ID="txtDiaChi" runat="server" CssClass="input"></asp:TextBox></div>
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ErrorMessage="" ControlToValidate="txtDiaChi" ForeColor="Red">Bạn chưa nhập địa chỉ</asp:RequiredFieldValidator>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="nhap"><asp:TextBox ID="txtSdt" runat="server" CssClass="input"></asp:TextBox></div>
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" ErrorMessage="" ControlToValidate="txtSdt" ForeColor="Red">Bạn chưa nhập sdt</asp:RequiredFieldValidator>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="nhap">
                                        ...
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator7" runat="server" ErrorMessage="" ControlToValidate="txtEmail" ForeColor="Red">Bạn chưa nhập Email</asp:RequiredFieldValidator>
                                        <asp:RegularExpressionValidator ID="RegularExpressionValidator9" runat="server" ErrorMessage="Email không hợp lệ" ControlToValidate="txtEmail" ForeColor="Red" ValidationExpression="\w+([-+.']\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*">*</asp:RegularExpressionValidator>
                                    </div>  
                                </td>
                            </tr>
                        </table>           
