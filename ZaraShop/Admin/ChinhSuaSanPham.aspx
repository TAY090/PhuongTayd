            ...
            <div class="form">
                ...
                <div class="thongtin">
                    ...
                    <div class="nhap">
                        ...
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ErrorMessage="" ControlToValidate="txtGiaKM" ForeColor="Red" Text="(Bạn chưa nhập giá khuyến mãi   )" SetFocusOnError="True"></asp:RequiredFieldValidator>
                    </div>
                </div>
                ...
                <div class="thongtin">
                    ...
                    <div class="nhap">
                        ...
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage="" ControlToValidate="txtNgayTao" ForeColor="Red" Text="(Bạn chưa nhập ngày)" SetFocusOnError="True"></asp:RequiredFieldValidator>
                    </div>
                </div>
